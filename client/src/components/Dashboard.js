...
export default function Dashboard() {
    ...
    if (isLoading) {
        return (
            <div className='xxs:absolute xxs:top-1/2 xxs:-translate-y-1/2 xxs:px-4'>
        ...
        <>
            <div className='xxs:px-4 xxs:mt-14'>
                ...
                <div className='xxs:bg-gray-100 xxs:p-6 xxs:py-8 xxs:flex xxs:flex-col xxs:items-center'>
                    ...
                    className='xxs:p-3 xxs:bg-black xxs:text-white xxs:mt-6 xxs:rounded-md hover:bg-gray-100 hover:text-black'>Start Shopping</button>
                </div>
                ...
                <div className='xxs:bg-gray-100 xxs:p-6 xxs:py-8 xxs:mb-16 xxs:flex xxs:flex-col xxs:items-center'>
                    ...
                    <button className='xxs:bg-blue-500 xxs:text-white xxs:p-3 xxs:w-full xxs:rounded-md xxs:mt-4 hover:bg-gray-100 hover:text-black hover:border-1 hover:border-blue-500'>View Account Details</button>
                </div>
            </div>
            <Navbar />
            <Footer />
...
const LegoVipCard = () => {
    return (
        <div className='xxs:bg-blue-700 xxs:rounded-lg xxs:p-4 xxs:flex xxs:flex-col xxs:items-center'>
            ...
            <button className='xxs:bg-white xxs:mt-5 xxs:py-3 xxs:w-full xxs:rounded-sm'>Join VIP</button>
        </div>
    );
}